...
var handlers = [/*#__PURE__*/msw.rest.get('/api/issues', function (req, res, ctx) {
...
}), /*#__PURE__*/msw.rest.get('/api/issues/:number', function (req, res, ctx) {
...
}), /*#__PURE__*/msw.rest.get('/api/issues/:number/comments', function (req, res, ctx) {
  var number = Number(req.params.number);
  var issue = issues.find(function (issue) {
    return issue.number === number;
  });
...
}), /*#__PURE__*/msw.rest.post('/api/issues/:number/comments', function (req, res, ctx) {
  var number = Number(req.params.number);
  var issue = issues.find(function (issue) {
    return issue.number === number;
  });
...
}), /*#__PURE__*/msw.rest.put('/api/issues/:number', function (req, res, ctx) {
  var number = Number(req.params.number);
  var issue = issues.find(function (issue) {
    return issue.number === number;
  });
  ...
  return res(ctx.status(200), ctx.json(issue));
}), /*#__PURE__*/msw.rest.post('/api/issues/:number/complete', function (req, res, ctx) {
  var number = Number(req.params.number);
  var issue = issues.find(function (issue) {
    return issue.number === number;
  });
  ...
  issue.status = 'done';
  return res(ctx.status(200), ctx.json(issue));
}), /*#__PURE__*/msw.rest.post('/api/issues', function (req, res, ctx) {
  var body = JSON.parse(req.body);
...
}), /*#__PURE__*/msw.rest.get('/api/labels', function (_req, res, ctx) {
  return res(ctx.status(200), ctx.json(labels));
}), /*#__PURE__*/msw.rest.get('/api/labels/:labelId', function (req, res, ctx) {
...
}), /*#__PURE__*/msw.rest.post('/api/labels', function (req, res, ctx) {
  ...
  labels.push(label);
  return res(ctx.status(200), ctx.json(label));
}), /*#__PURE__*/msw.rest.put('/api/labels/:labelId', function (req, res, ctx) {
  var labelId = req.params.labelId;
  var label = labels.find(function (l) {
    return l.name === labelId;
  });
  ...
  return res(ctx.status(200), ctx.json(label));
}), /*#__PURE__*/msw.rest["delete"]('/api/labels/:labelId', function (req, res, ctx) {
  var labelId = req.params.labelId;
  var label = labels.find(function (l) {
    return l.name === labelId;
  });
  ...
  return res(ctx.status(200), ctx.json(labels));
}), /*#__PURE__*/msw.rest.get('/api/users', function (_req, res, ctx) {
  return res(ctx.status(200), ctx.json(users));
})];

var worker = /*#__PURE__*/msw.setupWorker.apply(void 0, handlers);

exports.worker = worker;
//# sourceMappingURL=react-query-api.cjs.development.js.map
